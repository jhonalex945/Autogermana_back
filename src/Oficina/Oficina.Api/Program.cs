...
builder.Services.AddTransient<IConcesionarioQueryService, ConcesionarioQueryService>();
builder.Services.AddAutoMapper(typeof(AutoMapperProfiles));
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(ConcesionarioCreateCommand).Assembly));
